                    ...
                    <div class="panel-body">
                        <form accept-charset="utf-8" enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{route('create_link')}}">
                            ...
                            <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="link" type="text" class="form-control" name="link" placeholder="Link" value="{{ old('link') }}" required
                                           autofocus>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea name="description" id="description" cols="30" rows="10" placeholder="Description" class="form-control" required>{{ old('description') }}</textarea>
